...
- Статусы «задано заказчиком», «уточнено оператором» и «свободный
  комментарий» требуют конкретного value.
...
''', TOOLS=ctx.render_tools(), SECTIONS=sections, FIRST=CANONICAL_BLOCKS[0],
       N_BLOCKS=str(len(CANONICAL_BLOCKS)))
