...
extract_query_filters_prompt = (
    ...
    "\nReturn them as research_domains: a list of objects with domain and sub_domains keys."
    "\nEach object may contain at most three sub_domains. Keep every sub-domain in the object for its matching domain."
    "\nIf no broad domain is clearly mentioned or implied, set research_domains = null."
    "\nResearch sub-domains must belong to their selected domain according to this mapping:"
    f"\n{DOMAIN_SUBDOMAIN_MAPPING}"
    "\nIf a domain is clear but no sub-domain is clear, return that domain with sub_domains = null."
    "\nIf research domains or sub-domains cannot be specifically matched, set research_domains = null."
    "\n\nIf no specific filter is mentioned for a field, leave it as null."
    "\n\nExamples:"
    "\nQ: 'What did Sam Smith say about catalysis?'"
    "\nA: {\"paper_authors\": [\"Sam Smith\"], \"publication_year_min\": null, \"publication_year_max\": null, \"publication_year_exact\": null, \"publication_source\": null, \"research_domains\": [{\"domain\": \"Physical Sciences\", \"sub_domains\": [\"Chemistry\", \"Chemical Engineering\"]}]}"

    "\n\nQ: 'What are recent advances in polymer chemistry?'"
    "\nA: {\"paper_authors\": null, \"publication_year_min\": 2024, \"publication_year_max\": null, \"publication_year_exact\": null, \"publication_source\": null, \"research_domains\": [{\"domain\": \"Physical Sciences\", \"sub_domains\": [\"Chemistry\", \"Materials Science\", \"Chemical Engineering\"]}]}"

    "\n\nQ: 'Show me studies on protein folding dynamics since 2021'"
    "\nA: {\"paper_authors\": null, \"publication_year_min\": 2021, \"publication_year_max\": null, \"publication_year_exact\": null, \"publication_source\": null, \"research_domains\": [{\"domain\": \"Life Sciences\", \"sub_domains\": [\"Biochemistry, Genetics and Molecular Biology\"]}]}"

    "\n\nQ: 'Any papers on machine learning for molecular property prediction in Science from 2022?'"
    "\nA: {\"paper_authors\": null, \"publication_year_min\": null, \"publication_year_max\": null, \"publication_year_exact\": 2022, \"publication_source\": \"Science\", \"research_domains\": [{\"domain\": \"Physical Sciences\", \"sub_domains\": [\"Computer Science\", \"Chemistry\", \"Materials Science\"]}]}"

    "\n\nQ: 'What quantum simulation methods are used in condensed matter physics?'"
    "\nA: {\"paper_authors\": null, \"publication_year_min\": null, \"publication_year_max\": null, \"publication_year_exact\": null, \"publication_source\": null, \"research_domains\": [{\"domain\": \"Physical Sciences\", \"sub_domains\": [\"Physics and Astronomy\", \"Computer Science\", \"Mathematics\"]}]}"
)
