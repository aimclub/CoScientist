      ...
      },
      {
        ...
        groups: [
          ...
          },
          {
            heading: 'alembic',
            fields: [
              { id: 'hubSearch', path: 'alembicHub.searchEnabled', type: 'toggle', scope: 'instant', env: 'ALEMBIC_HUB__SEARCH_ENABLED' },
              { id: 'hubAutoUpload', path: 'alembicHub.autoUpload', type: 'toggle', scope: 'instant', env: 'ALEMBIC_HUB__AUTO_UPLOAD' },
              { id: 'agentBuild', path: 'alembicHub.agentBuildEnabled', type: 'toggle', scope: 'instant', env: 'ALEMBIC__AGENT_BUILD_ENABLED' },
            ],
          },
          {
