...
const i18n = {
  ...
  'graph.summary.button': { en: 'view summary', ru: 'посмотреть отчёт' },
  'graph.summary.hint': { en: 'a small model reads this agent\'s trace and writes a few lines on what was done and with which tools', ru: 'небольшая модель прочитает трассу этого агента и напишет несколько строк о том, что сделано и какими инструментами' },
