    ...
    const i18n = {
      ...
      'hitl.frame.title': { en: 'Research Frame', ru: 'Рамка исследования' },
      'hitl.frame.notSet': { en: 'not set', ru: 'не задано' },
      'hitl.frame.placeholder': { en: 'Leave empty to let the agent fill in a working value', ru: 'Оставьте пустым, чтобы агент подставил рабочее значение' },
      'hitl.frame.sidebarHint': { en: 'Fill in the form in the chat. The agent fills empty fields itself.', ru: 'Заполните форму в чате. Пустые поля агент заполнит сам.' },
      'hitl.frame.save': { en: 'Save frame', ru: 'Сохранить рамку' },
      'hitl.frame.skip': { en: 'Skip (agent decides)', ru: 'Пропустить (агент решит)' },
      'hitl.frame.saved': { en: '✓ Frame saved ({count} field(s) set by operator)', ru: '✓ Рамка сохранена ({count} поле(й) заданы оператором)' },
      'hitl.frame.skipped': { en: '→ Frame skipped — the agent will fill in values', ru: '→ Рамка пропущена — агент подставит значения' },
      ...
      'graph.live': { en: 'live (1.5s)', ru: 'обновление (1.5 с)' },
      'graph.refresh': { en: 'refresh', ru: 'обновить' },
      'graph.view': { en: 'view:', ru: 'вид:' },
      'graph.view.research': { en: 'research graph (blackboard)', ru: 'граф исследований (доска)' },
      'graph.view.execution': { en: 'execution (log)', ru: 'выполнение (лог)' },
      'graph.view.knowledge': { en: 'knowledge (this session)', ru: 'знания (эта сессия)' },
      'graph.view.memory': { en: 'knowledge memory (global)', ru: 'память знаний (глобальная)' },
      ...
      'graph.legend.status': { en: 'status:', ru: 'статус:' },
      'graph.legend.type': { en: 'type:', ru: 'тип:' },
      'graph.legend.edge': { en: 'edge:', ru: 'связь:' },
      'graph.legend.running': { en: 'running', ru: 'в работе' },
      'graph.legend.success': { en: 'success', ru: 'успех' },
      'graph.legend.failed': { en: 'failed', ru: 'ошибка' },
      'graph.legend.system': { en: 'system', ru: 'система' },
      'graph.legend.agent': { en: 'agent', ru: 'агент' },
      'graph.legend.goal': { en: 'goal', ru: 'цель' },
      'graph.legend.tool': { en: 'tool', ru: 'инструмент' },
      'graph.legend.result': { en: 'result', ru: 'результат' },
      'graph.legend.confirmed': { en: 'confirmed / validated / done', ru: 'подтверждено / проверено / готово' },
      'graph.legend.inProgress': { en: 'in progress', ru: 'в работе' },
      'graph.legend.refuted': { en: 'refuted / failed', ru: 'опровергнуто / ошибка' },
      'graph.legend.open': { en: 'open / formulated / planned', ru: 'открыто / сформулировано / запланировано' },
      'graph.legend.needsTool': { en: 'needs tool / being built', ru: 'нужен инструмент / создаётся' },
      'graph.legend.postponed': { en: 'postponed / exhausted', ru: 'отложено / исчерпано' },
      'graph.legend.supports': { en: 'supports', ru: 'поддерживает' },
      'graph.legend.refutes': { en: 'refutes', ru: 'опровергает' },
      'graph.legend.rTypes': { en: '❓question 💡hypothesis 🔬evidence ⚙️method 🎯criteria 🔧tool', ru: '❓вопрос 💡гипотеза 🔬данные ⚙️метод 🎯критерии 🔧инструмент' },
      'graph.detail.source': { en: 'source:', ru: 'источник:' },
      'graph.detail.attributes': { en: 'attributes:', ru: 'атрибуты:' },
      'graph.detail.kind': { en: 'kind', ru: 'тип' },
      'graph.detail.agent': { en: 'agent', ru: 'агент' },
      'graph.detail.duration': { en: 'duration', ru: 'длительность' },
      'graph.detail.agentPrompt': { en: 'prompt the agent was called with', ru: 'промпт вызова агента' },
      'graph.detail.toolArgs': { en: 'tool args', ru: 'аргументы инструмента' },
      'graph.detail.input': { en: 'input', ru: 'вход' },
      'graph.detail.output': { en: 'output', ru: 'результат' },

      // ── Standalone builds pages ──
      'builds.backChat': { en: '← chat', ru: '← чат' },
      'builds.refresh': { en: 'Refresh', ru: 'Обновить' },
      'builds.empty': {
        en: 'No builds yet. Ask the MCP Builder agent to build a repo, e.g. "build an MCP server from https://github.com/whitead/synspace".',
        ru: 'Сборок пока нет. Попросите агента MCP Builder собрать репозиторий, например: «собери MCP-сервер из https://github.com/whitead/synspace».'
      },
      'builds.stage': { en: 'stage {stage}', ru: 'этап {stage}' },
      'builds.errorLabel': { en: 'error', ru: 'ошибка' },
      'builds.thJob': { en: 'Job', ru: 'Задача' },
      'builds.thRepo': { en: 'Repository', ru: 'Репозиторий' },
      'builds.thStatus': { en: 'Status', ru: 'Статус' },
      'builds.loadFailed': { en: 'Failed to load builds: {error}', ru: 'Не удалось загрузить сборки: {error}' },
      'builds.loading': { en: 'Loading…', ru: 'Загрузка…' },
      'builds.status.running': { en: 'running', ru: 'выполняется' },
      'builds.status.done': { en: 'done', ru: 'готово' },
      'builds.status.failed': { en: 'failed', ru: 'ошибка' },
      'builds.status.error': { en: 'error', ru: 'сбой' },
      'build.backAll': { en: '← all builds', ru: '← все сборки' },
      'build.connecting': { en: 'connecting', ru: 'подключение' },
      'build.pipeline': { en: 'Pipeline', ru: 'Конвейер' },
      'build.result': { en: 'Result', ru: 'Результат' },
      'build.validation': { en: 'Tool validation', ru: 'Проверка инструментов' },
      'build.liveLog': { en: 'Live log', ru: 'Лог в реальном времени' },
      'build.stage.pending': { en: 'pending', ru: 'ожидает' },
      'build.stage.running': { en: 'running…', ru: 'выполняется…' },
      'build.stage.done': { en: 'done', ru: 'готово' },
      'build.stage.failed': { en: 'failed', ru: 'ошибка' },
      'build.badge.running': { en: 'running', ru: 'выполняется' },
      'build.badge.done': { en: 'done', ru: 'готово' },
      'build.badge.failed': { en: 'failed', ru: 'ошибка' },
      'build.badge.disconnected': { en: 'disconnected', ru: 'отключено' },
      'build.badge.error': { en: 'error', ru: 'ошибка' },
      'build.badge.unknown': { en: 'unknown', ru: 'неизвестно' },
      'build.failed': { en: 'Build failed.', ru: 'Сборка завершилась ошибкой.' },
      'build.noUrl': { en: 'Build finished but no MCP URL was printed — check the log.', ru: 'Сборка завершена, но URL сервера MCP не выведен — проверьте лог.' },
      'build.seeLog': { en: 'see log', ru: 'см. лог' },
      'build.resets': { en: ' (after {count} reset(s))', ru: ' (после сбросов: {count})' },
      'build.pass': { en: 'pass', ru: 'успех' },
      'build.fail': { en: 'fail', ru: 'ошибка' },
    };
