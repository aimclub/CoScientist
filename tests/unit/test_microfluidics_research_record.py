...
ANALYSIS = {
    ...
    "source_records": [
        {"source_id": "S1", "title": "Mannich bases of hindered phenols", "doi": "10.1/abc",
    ...
    "analogues": [{"name": "Агидол-1", "smiles": "Cc1cc(C(C)(C)C)c(O)c(C(C)(C)C)c1",
                   ...
                   "relevance": "тот же класс", "sources": ["10.1/abc"]}],
    "synthesis_routes": [{
        "product": "Агидол-3",
        ...
        "flow_suitability": "гомогенная, подходит", "sources": ["10.1/abc"],
